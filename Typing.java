...
public class Typing {
   ...
   public static void main(String[] args) {
       ...
       while (continueTesting) {
           ...
           int accurateWordsCount = 0;
           while (currentWordIndex < wordsList.size()) {
               ...
               for (String word : typedWords) {
                   if (currentWordIndex < wordsList.size() && word.equals(wordsList.get(currentWordIndex))) {
                       userInputs.add(word);
                       accurateWordsCount++;
                       currentWordIndex++;
                   }
           ...
           double wordsPerMinute = accurateWordsCount / timeTakenMinutes;

           // Set terminal text color to yellow
           System.out.println("\u001B[33mWords per minute: " + wordsPerMinute + "\u001B[0m");
           System.out.println("Total accurate words typed: " + accurateWordsCount);
